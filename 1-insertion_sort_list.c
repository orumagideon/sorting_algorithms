...
/**
 * swap_nodes - Two swap nodes in listint_t doubly-linked lst.
...
/**
 * insertion_sort_list - SFunc srts a doubly linked list of integers
 *                       using insertion sort algorithm.
 * @list: Pointer to the head of a doubly-linked list of integers.
 *
 * Description: List after each swap.
 */
